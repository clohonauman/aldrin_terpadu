                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($rombel['kurikulum'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                                ...
                                <td><a class="btn btn-primary" href="<?= Yii::$app->urlManager->createUrl('rombel?id='.htmlspecialchars($ptk['ptk_id'] ?? '', ENT_QUOTES, 'UTF-8')) ?>"><i class="fa fa-eye"></i></a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
