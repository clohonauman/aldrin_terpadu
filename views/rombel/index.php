...
<div class="card">
    ...
    <div class="col-sm-12">
            <h1>
                <i class="fa fa-database icon-title"></i> DATA ROMBEL
            </h1>
        </div>
    </div>
    <div class="card-body">
        ...
        <section class="content">
            ...
            <div class="row mb-4">
                <div class="col-md-6 text-left">
                    <h4><i class="fa fa-sitemap"></i> DAFTAR ROMBEL</h4>
                </div>
                <?php
                if(Yii::$app->session->get('kode_akses')==3){
                    ?>
                    <div class="col-md-6 text-right">
                        <a href="<?= Yii::$app->urlManager->createUrl(['/rombel/insert']) ?>" class="btn btn-primary">
                    ...
                    <tbody>
                        <?php
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($rombel['nama_sekolah'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($rombel['bentuk_pendidikan'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($rombel['status_sekolah'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($rombel['kecamatan'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>

                                <td><?= htmlspecialchars($rombel['nama'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($rombel['mata_pelajaran'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($rombel['nama_ptk'] ?? '', ENT_QUOTES, 'UTF-8') ?></td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" onclick="return confirm('Anda yakin ingin menghapus rombel ini dan semua pembelajaran yang terikat pada rombel ini. Perubahan tidak bisa dibatalkan. Lanjutkan?')" href="<?= Yii::$app->urlManager->createUrl('rombel/delete?id='.htmlspecialchars($rombel['rombongan_belajar_id'] ?? '', ENT_QUOTES, 'UTF-8')) ?>"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
