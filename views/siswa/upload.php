    ...
    if (Yii::$app->session->get('kode_akses')!=3) {
        ...
        <div class="card-header">
            <div class="col-sm-12 text-right">
                <a href="<?= Yii::$app->urlManager->createUrl(['/siswa/insert']) ?>" class="btn btn-secondary"><i class="fa fa-plus"></i> TANPA EXCEL</a>
            </div>
        </div>
        <?php
    }
                ...
                <div class="col-lg-12 col-xs-12">
                    <div class="card alert alert-danger alert-dismissable">
                        ...
                        <p style="font-size:15px">
                            Pastikan file excel yang diunggah adalah hasil unduhan dari Dapodik Sekolah. Terima kasih.
                        </p>        
                    </div>
                </div>
            </div>
